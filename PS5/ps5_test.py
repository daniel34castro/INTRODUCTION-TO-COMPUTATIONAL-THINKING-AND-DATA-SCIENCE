...
class TestPS5(unittest.TestCase):
	...
	def test_gen_std_devs(self):
		...
		for index in range(len(correct)):
			good_enough = math.isclose(correct[index], result[index])
			self.assertTrue(good_enough, "1.Standard deviations do not match expected results")
		...
		for index in range(len(correct)):
			good_enough = math.isclose(correct[index], result[index])
			self.assertTrue(good_enough, "2.Standard deviations do not match expected results")
		...
		for index in range(len(correct)):
			good_enough = math.isclose(correct[index], result[index])
			self.assertTrue(good_enough, "3.Standard deviations do not match expected results")
